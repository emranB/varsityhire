...
<ul>
	...
	<div class="row lowerRow">
		<li class="leftItems"><a id="" <?=echoSelectedClassIfRequestMatches("postJob")?> href="pages/postJob.php">Post Job</a></li>
		...
		<li class="leftItems"><a id="" <?=echoSelectedClassIfRequestMatches("showJobsForOneClient")?> href="pages/showJobsForOneClient.php" >My Job Listings</a></li>
		<li class="leftItems"><a id="" <?=echoSelectedClassIfRequestMatches("history")?> href="pages/history.php">Job History</a></li>
...
<div class="col-cs-12 col-md-12 col-lg-12">
